...
return(
    <div className='fixed inset-0 z-0 overflow-hidden'>
        {Background ===video?(
            <video autoPlay loop muted className='w-full h-full opacity-100 object-cover pointer-events-none animate-fade-in'>
                <source src={video} type='video/mp4'/>
            </video>
        ):(
            <img src={Background} alt="Weather-bg" className='w-full h-full object-center opacity-20 pointer-events-none animate-fade-in' />
        )}
